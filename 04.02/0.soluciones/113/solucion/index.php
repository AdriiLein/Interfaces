<?php
// html elementos de la pagina
// css  estilos de los elementos
// js   eventos
// php  segunda peticion para calcular el numero hexadecimal

// lenguaje: strtoupper, str_pad,dechex, XMLHttpRequest, xhttp.open, xhttp.send
...
<script type="text/javascript">
	...
	function envio(){
		...
		xhttp.open("GET","index.php?"+"r="+r+"&g="+g+"&b="+b, true);
		xhttp.send();			
	}
